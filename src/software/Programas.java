...
public class Programas {
    ...
    public Word[] pa = new Word[] {
            ...
            new Word(Opcode.STX, 2, 5, -1), // 8 pega o valor do r5 e carrega na posição 900 (valor armazenado no
                                            // r2)
            ...
            new Word(Opcode.SWAP, 5, 6, -1), // 19 faz um swap dos registradores r5 e r6 para manter a ordem correta
                                                // para somar
            ...
            new Word(Opcode.JMPIG, 4, 1, -1), // 22 se o que tem no r1 é maior que 0, volta pra instrução 15, se
                                                // não, segue
            ...
            new Word(Opcode.STX, 2, 3, -1), // 25 pega o que tá no r3 (-1) e coloca na posição de memória do r2
                                            // (900)
    ...
    public Word[] pb = new Word[] {
            ...
            new Word(Opcode.JMPIG, 6, 1, -1), // 10 se for maior que 0 o que tem no r1, volta pra instrução 7 se
                                                // não, segue o fluxo
            new Word(Opcode.STD, 2, -1, 35), // 11 coloca na posição 35 da memória o resultado do fatorial, que está
                                                // no r2
    ...
    public Word[] paInput = new Word[] {
            ...
            new Word(Opcode.SUBI, 1, -1, 1), // 6 subtrai 1 do valor que entrou (no caso 5), por conta do zero: 0-4
                                                // (5 valores)
            new Word(Opcode.LDI, 2, -1, 900), // 7 registrador que vai controlar o incremento de posição de memória
            ...
            new Word(Opcode.STX, 2, 5, -1), // 11pega o valor do r5 e carrega na posição 900 (valor armazenado no
                                            // r2)
            ...
            new Word(Opcode.SWAP, 5, 6, -1), // 22 faz um swap dos registradores r5 e r6 para manter a ordem correta
                                                // para somar
            ...
            new Word(Opcode.JMPIG, 4, 1, -1), // 25 se o que tem no r1 é maior que 0, volta pra instrução 14, se
                                                // não, segue
            new Word(Opcode.JMPIL, 7, 1, -1), // 26 se o que tem no r1 for menor que 0, pula pra instrução 26
            new Word(Opcode.LDI, 3, -1, -1), // 27 carrega -1 no r3
            new Word(Opcode.STX, 2, 3, -1), // 28 pega o que tá no r3 (-1) e coloca na posição de memória do r2
                                            // (900)
    ...
    public Word[] pbOutput = new Word[] {
            ...
            new Word(Opcode.LDI, 9, -1, 35), // 16 coloca 6 no reg 9, ou seja a posição onde será feita a leitura
